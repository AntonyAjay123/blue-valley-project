...
export const northTownLocation = 'Bangalore, acknowledged as Asia’s fastest growing cosmopolitan city and the IT hub makes for a perfect backdrop to Smilee Anandavana I. While envisioning an idyllic lifestyle at Smilee Anandavana I, we have ensured the lush locale has been placed within easy reach of Bangalore city. The prestigious enclave is situated in Doddaballapur Road connecting Dobbaspet and Hoskote, about 29 kms from Vidhana Soudha and 17 kms from Yelahanka Town. Global connectivity makes its presence felt with Bangalore’s International Airport being within a distance of just 12 kms away.'
export const madhubanAddress='Savakanahalli Village, Kasaba Hobli, Devanahalli, Bengaluru Rural - 562110'
